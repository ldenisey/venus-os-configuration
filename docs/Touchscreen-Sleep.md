...
If it works, make it persistent to firmware update by [installing opkg-persist](./VenusOS-Opkg_persist.md#how-to-install-it) then :
``` bash
opkg-persist install blank-display-device
```
